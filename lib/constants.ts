...
export const MALE_VOICES = [
  { id: "dave", name: "Dave", description: "English, conversational" },
  { id: "daniel", name: "Daniel", description: "English, professional" },
  { id: "chris", name: "Chris", description: "English, warm" },
] as const;

export const FEMALE_VOICES = [
  { id: "rachel", name: "Rachel", description: "English, clear" },
  { id: "sarah", name: "Sarah", description: "English, friendly" },
] as const;
